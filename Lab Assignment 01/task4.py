...
Original file is located at
    https://colab.research.google.com/drive/1PTwHv9wP9rMKKbD2fFdXkuZFkLuhgre_
"""

#task 4
# Here I use Insertion Sort to sort the trains in the lexicographical order based
